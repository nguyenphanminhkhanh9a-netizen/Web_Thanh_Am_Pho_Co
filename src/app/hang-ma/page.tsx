    ...
    <>
      <main className="pt-0">
        ...
        <section className="relative w-full h-[716px] overflow-hidden">
          ...
          <div className="relative z-10 h-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex flex-col justify-end pb-16 items-start">
            <div className="bg-background/90 backdrop-blur-md p-8 md:p-12 border-l-4 border-primary shadow-2xl max-w-3xl transform transition-transform hover:scale-[1.02] duration-500">
              <span className="font-label-sm text-primary mb-3 tracking-[0.2em] uppercase block">Không gian lễ hội</span>
              <h1 className="font-display-lg text-display-lg md:text-[64px] text-primary leading-tight mb-4 italic">
                Phố Hàng Mã: <br/>Không gian lễ hội & Đồ chơi dân gian
              </h1>
              <p className="font-body-md text-on-surface-variant text-lg italic">
